...
var help = [
  ...
  '  -r, --rotate     Byte threshold for the size of OUTFILE and ERRFILE (default 0) for',
  '                       the purpose of rotation. A value of 0 indicates no rotation.',
  '  -z               GZ Compression level for use in rotation. A value of 0 will not compress.',
...
var getOptions = cli.getOptions = function (file) {
  var options = {},
      ...
      configKeys = [
        ...
        'killTree', 'killSignal', 'id', 'rotate', 'compress'
      ],
